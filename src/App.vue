...
<template>
  <div class="ode">
    ...
    <nav class="nav">
      ...
      <div class="nav-right">
        <a href="#studio" class="navlink">The studio</a>
        <a href="#listen" class="navlink">Listen</a>
    ...
    <main>
        ...
        <div class="hero-inner">
          <div class="hero-left">
            ...
            <h1 class="display">
              ...
              <em>your words already live.</em>
            </h1>
            <p class="lede">
              Remanso Studio records, cuts and mixes audio in the browser, then hands you a markdown
              link to paste into a note. The recording lands in your own PDS, next to everything
              else you have published. There is no upload to a platform you do not own.
            </p>
            <p class="hero-sample">
              The writing half lives at
              <a href="https://remanso.space">remanso.space</a>. This is the half that speaks.
            </p>
          </div>
      ...
      <section class="rooms">
        <div class="rooms-inner">
          <article class="room" id="studio">
            <div class="room-head">
              <span class="room-n mono">01</span>
              <div>
            ...
            <p class="room-copy">
              Record a take from your microphone, or bring a file you recorded elsewhere. Trim the
              ends, drop the long pauses, and set the loudness once so it plays at the level a
              podcast should. Mix in a sting or a bed of river sound where it belongs. When it
              sounds right, publish a <code class="mono">space.remanso.recording</code> to your PDS
              and copy the link. Paste it into a note and the audio plays where the note is read.
            </p>
          </article>

          <article class="room" id="listen">
            <div class="room-head">
              <span class="room-n mono">02</span>
              <div>
      ...
      <section class="manifesto">
        <div class="manifesto-inner">
          ...
          <p class="drop-cap manifesto-p">
            <em>Remanso</em> is a Portuguese word for the still pool that forms where a river slows.
            The water keeps moving through it, but for a stretch it holds calm enough to see the
            bottom. remanso.space gave that to writing. Remanso Studio gives it to sound: somewhere
            to record a thing, work it until it is clear, and set it down where it will keep.
          </p>
        </div>
      </section>
          ...
          <ol class="steps">
            <li>
              ...
              <div>
                ...
                <p>
                  Speak into your microphone, or import a file you already have. A take is written
                  to disk as you go, so a reload or a closed tab mid-sentence does not cost you the
                  recording.
                </p>
              </div>
            </li>
            <li>
              ...
              <div>
                ...
                <p>
                  ...
                  segment needs it. Every edit points back at the original take, and every edit can
                  be undone.
                </p>
              </div>
            </li>
            <li>
              ...
              <div>
                ...
                <p>
                  ...
                  Paste it into the note it belongs to, commit, and the note republishes with the
                  audio playing inline.
                </p>
...
![Episode title - audio](at://…/space.remanso.recording/3lk…)</pre>
      ...
      <section class="sibling">
        <div class="sibling-inner">
          ...
          <p class="sibling-p">
            remanso.space is where you write. Remanso Studio is where you record. They share a
            handle, a mark, and the same habit of keeping your work in markdown you can take
            anywhere. Sign in on either with the account you already have.
          </p>
          <a href="https://remanso.space" class="sibling-cta">Open remanso.space →</a>
        </div>
      </section>
    </main>
...
.ripple {
  position: absolute;
  inset: 12%;
  border: 3px solid var(--hw-pink-wash-2);
  border-radius: 50%;
...
.how {
  ...
  background: linear-gradient(
    180deg,
    transparent,
    color-mix(in srgb, var(--hw-pink-wash) 35%, transparent) 45%,
    transparent
  );
}
